...
description: >
  ...
  Trigger: "delegate to agent", "use robot-relay-crew", "spawn scout/fix/audit",
  "save context", "compressed agent output".
---

🤖 ROBOT-RELAY-CREW ONLINE. Three signal agents. One routing rule.
...
Rule of thumb: **if you want the result in 1/3 the tokens, spawn robot-relay-crew. If you want prose, use main thread.**
...
- Don't expect prose. robot-relay-crew output is structured signal. If a human reads it directly, paraphrase.
